...
For example this technique is used to:
 1. reduce number of transaction on chain
 2. gas-less transaction, called meta transaction
...
contract MultiSigWallet {
    ...
    function transfer(address _to, uint _amount, bytes[2] memory _sigs) external {
        bytes32 txHash = getHash(_to, _amount);
    ...
    function getHash(address _to, uint _amount) public view returns(bytes32) {
